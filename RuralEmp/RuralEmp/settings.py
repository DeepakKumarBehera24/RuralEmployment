"""
Django settings for RuralEmp project.
...
SECRET_KEY = '8pxu6asxcx*p&&k&x!jmw*tpb&#0x3hyx3-s84u@o1-t702i^c'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'R_E.context_processors.current_year',  # Add this line
            ],
        },
    },
]

WSGI_APPLICATION = 'RuralEmp.wsgi.application'
